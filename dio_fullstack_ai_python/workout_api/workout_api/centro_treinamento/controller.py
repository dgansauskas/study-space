...
@router.get(
    path='/', 
    summary='Consultar todos os centros de treinamentos criados',
...
async def query(
    ...
    if not centro_treinamento_out:
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail=f'Centro de Treinamento {id} não encontrado')
